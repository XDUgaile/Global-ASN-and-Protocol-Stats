...
if __name__ == "__main__":
    # 基础URL模板
    base_url_template = "http://archive.routeviews.org/route-views6/bgpdata/{year}.{month:02d}/RIBS"
    ...
    # 并行下载所有文件
    download_all_files(urls, save_directory, proxies=proxies, max_workers=4)
